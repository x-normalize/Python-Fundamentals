...
1. Релационни (Relational / SQL) бази данни
	...
	- за да модифицираме данните в таблиците -> MySQL, PosgreSQL
	- софтуер MySQL Workbench за модификация на релационни бази от данни с MySQL
...
2. Нерелационни (Non-relational / NoSQL) бази данни
	...
	- за да модифицираме данните -> MongoDB
	- софтуер MongoDB Compass за модификация на нерелационни бази от данни с MongoDB
